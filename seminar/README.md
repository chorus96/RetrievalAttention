...
9. RetroInfer 알고리즘 (의사코드) — Prefill 인덱스 구축 + Decode 3-zone
10. 고성능 CUDA / C++ 커널
11. 성능 — 정확도 유지, 처리량 4.5–10.5×
12. 하드웨어 요구사항과 한계 (Ampere sm_80+)
13. 레퍼런스 하드웨어 — NVIDIA A100 (Ampere) 구조

**Part 2. 실전 사용 (README.kr.md 기반)**
14. 실전 ① 환경 설정 & 커널 설치
15. 실전 ② 데모 실행 & API
16. 실전 ③ 정확도 벤치마크 (RULER / LongBench / Reasoning)
17. 실전 ④ 처리량 재현 & 새 방법 추가

18. 요약 & 참고문헌

> 알고리즘 상세 설명은 [`note.md` §16 RetroInfer 알고리즘 총정리](./note.md#16-retroinfer-알고리즘-총정리-end-to-end) 참고.
